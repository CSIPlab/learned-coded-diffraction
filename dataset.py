...
data_root = './data'
# data_root = '/media/lab/phase-retrieval/data'
...
def load_CELEBA(size = None, N_1k = 0, channel = -1):
    # download dataset https://drive.google.com/file/d/0B7EVK8r0v71pZjFTYXZWM3FlRnM/view
    from pathlib import Path
    ...
    N = len(names)
    assert N > 0, f'Data not found! Please download CelebA dataset: https://drive.google.com/file/d/0B7EVK8r0v71pZjFTYXZWM3FlRnM/view\nAnd unzip into folder {data_dir}.'
